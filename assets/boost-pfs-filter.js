...
(function() {
    ...
    Utils.sticky = function ($stickyElement, endElement, avoidElement) {
        ...
        var setPosition = () => {
            ...
            var endPos = jQ(endElement).position().top + jQ(endElement).outerHeight() - 300;
...
console.log(jQ(endElement).height(), windowHeight, stickHeight)
            ...
            // Fixed Position
            } else if (window.scrollY + stickHeight - 500 <= endPos) {
